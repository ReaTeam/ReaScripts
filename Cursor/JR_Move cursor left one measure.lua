-- @description Move cursor left one measure
-- @author JRTaylorMusic
-- @version 1.0

--[[
 * ReaScript Name: Move cursor left one measure
 * Description: 
 * Instructions: Run
 * Screenshot: 
 * Author: 
...
reaper.Undo_EndBlock("Move cursor left one measure", -1) -- End of the undo block. Leave it at the bottom of your main function.
