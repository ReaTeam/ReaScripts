-- @description Create 10 Minute Regions v1.0
-- @author Senhor A
-- @version 1.0
-- @about
--   # Create 10 Minute Regions v1.0
--
--   Separates the project into regions of 10 minutes each to facilitate the organization of long projects.
