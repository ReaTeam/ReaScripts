...
About:
    ...
    at the edit cursor, and can export specific settings as a
    separate action.
Extensions:
--]]
...
local function btn_save()
    ...
    local name =    "Lokasenna_Create time selection " .. length .. " " .. units ..
                    " long, " .. string.lower(position) .. " the edit cursor"
    
    -- Copy everything from the file between the ReaPack header and GUI stuff
    local file_in, err = io.open(script_filename, "r")
    if err then
    ...
    arr[1] = "-- This script was generated by Lokasenna_Create time selection at edit cursor... .lua\n"
