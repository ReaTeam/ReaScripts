-- @description import track group names
-- @author NICKS
-- @version 1.0.0alpha
-- @provides . > nicks_import_track_group_names.lua
-- @about
--   # Import track group names
--
--   Import the  the names of the track groups from a text file (one line per name).
