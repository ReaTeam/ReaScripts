-- @description Save project plugin info to text file (Don't open notepad on Windows)
-- @author Edgemeal
-- @version 1.06
-- @link Forum https://forum.cockos.com/showthread.php?t=225219
-- @donation Donate https://www.paypal.me/Edgemeal
-- @about Based on v1.06 of same named script, but does not open text file in Notepad on Windows when saved.
