...
-- @about
--   Vertical FX list that's similar to Doppelganger's fxlist script with some additional featrures:
--   See forum post for detail: 
...
function attachImages()
  local imageFolder = r.GetResourcePath() .. '/Scripts/ReaTeam Scripts/Tracks Properties/FXD Vertical FX List/Images/'
  Img = {
