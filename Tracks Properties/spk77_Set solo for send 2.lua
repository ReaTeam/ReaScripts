...
-- @description Set solo for send 2
-- @about
--   # Set solo for send 2
--
--   Sets solo for send number 2 (by muting all other sends on the track). This works on selected tracks.
...
function solo_send(send_index)
  ...
  reaper.Undo_EndBlock("Set solo for send 2", -1)
end
