...
--
--   Thanks also to Edgemeal for the code at the start of this script and Bfooz for some of the send code.

scriptName = "Add 1db to selected tracks sends via send window (or fader volume if no send window)"
