...
-- @description Set solo for send 3
-- @about
--   # Set solo for send 3
--
--   Sets solo for send number 3 (by muting all other sends on the track). This works on selected tracks.
...
function solo_send(send_index)
  ...
  reaper.Undo_EndBlock("Set solo for send 3", -1)
end
