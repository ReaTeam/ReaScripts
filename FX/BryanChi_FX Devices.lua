...
-- @author Bryan Chi
-- @version 1.0beta5
-- @changelog -Add FX Layouts for some Valhalla plugins
-- @provides
...
--   [data] BryanChi_FX Devices/ValhallaVintageVerb (Valhalla DSP, LLC).ini > BryanChi_FX Devices/FX Layouts/ValhallaVintageVerb (Valhalla DSP, LLC).ini
--   [data] BryanChi_FX Devices/ValhallaSupermassive (Valhalla DSP, LLC).ini > BryanChi_FX Devices/FX Layouts/ValhallaSupermassive (Valhalla DSP, LLC).ini
--   [data] BryanChi_FX Devices/ValhallaDelay _Valhalla DSP_ LLC_.ini > BryanChi_FX Devices/FX Layouts/ValhallaDelay _Valhalla DSP_ LLC_.ini
--   [data] BryanChi_FX Devices/ValhallaShimmer (Valhalla DSP, LLC).ini > BryanChi_FX Devices/FX Layouts/ValhallaShimmer (Valhalla DSP, LLC).ini
--   [data] BryanChi_FX Devices/ValhallaFreqEcho (Valhalla DSP, LLC).ini > BryanChi_FX Devices/FX Layouts/ValhallaFreqEcho (Valhalla DSP, LLC).ini
-- @about
