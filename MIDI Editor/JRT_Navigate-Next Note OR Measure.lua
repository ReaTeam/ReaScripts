...
@version 1.0
@provides . > JRT_Navigate-Next Note OR Measure
@about For streamlined MIDI Editor Navigation – includes OPTION TO AUTOSELECT IF NOTE(S) UNDER CURSOR (see line 19) pairs well with JRT_Navigate-Previous Note OR Measure.lua
