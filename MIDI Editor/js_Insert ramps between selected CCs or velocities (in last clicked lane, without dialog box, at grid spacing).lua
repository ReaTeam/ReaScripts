...
About: 
  ...
  This version of the script uses the following presets:
...
laneToUse = "last clicked" -- "under mouse" or "last clicked"

-- Default values for ramp shape:
shape = 1 -- Shape of the ramp.  Either "sine" (or "s"), or a number > 0 for a power curve (1 implies linear).
CCdensity = "g" -- "g" or "p". "g" uses the MIDI editor's current grid settings, whereas "p" uses the default CC density set in REAPER's Preferences -> MIDI editor -> Events per quarter note when drawing in CC lanes.
