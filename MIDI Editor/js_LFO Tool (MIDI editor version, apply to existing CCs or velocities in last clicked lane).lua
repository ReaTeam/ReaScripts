--[[
ReaScript name: LFO Tool (MIDI editor version, apply to existing CCs or velocities in last clicked lane)
Version: 2.31
Author: juliansader
...
About:
  ...
  This version applies the LFO to existing events -- velocities or CCs -- in the last clicked lane.
