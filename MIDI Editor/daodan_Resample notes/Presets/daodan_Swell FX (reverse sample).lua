...
--Have fun!
  ...
  shiftReversedSampleLeft = 1 --set to 1 to move item/note left to align reversed sample end to orig start. Useful for "Swell FX"
  ...
  useFullSample = 1 -- set 1 to include apply fx tail in resampled item. Affects both item in arrange and sampler
  ...
  postRenderAction = 1 -- run any action/script after rendering MIDI copy, before loading to sampler. Here selected item is rendered (audio) item placed on original track or new track if useNewTrack = 1
                     --0 - no action, 
                     --1 - main section, 2 - midi editor section
  postRenderActionID = '_FX31f0ba321e63464baff67b2136d3ddc55df8e546' -- post-render action id. Place inside ''. For example: '40515' or '_SWS_ITEMCUSTCOL1' or ''
