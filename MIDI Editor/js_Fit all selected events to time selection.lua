--[[
ReaScript name:  js_Fit all selected events to time selection.lua
Version: 2.00
Author: juliansader
...
About:
  ...
  Move and stretch all selected events in the active take (notes, sysex, pitchwheel, CCs etc - not limited to 
  any CC lane) to fit precisely into time selection.
  
  # Instructions
  
  The script can be linked to a shortcut key or a menu button, or it can be included in the CC lane context menu.
]]
...
-- Settings that the user can customize
    ...
    lane_to_use = "all" -- "all", "last clicked" or "under mouse"
...
--[[function main() 
    ...
    -------------------
    -- End and clean-up
    reaper.Undo_OnStateChange_Item(0, "Fit all selected events in active take to time selection", item)
