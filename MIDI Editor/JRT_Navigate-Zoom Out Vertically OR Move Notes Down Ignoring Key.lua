@description JRT_Navigate-Zoom Out Vertically OR Move Notes Down Ignoring Key
@author JRTaylorMusic
@version 1.0
@provides [main=main,midi_editor] . > JRT_Navigate-Zoom Out Vertically OR Move Notes Down Ignoring Key
@about For streamlined MIDI Editor Navigation – pairs well with JRT_Navigate-Zoom In Vertically OR Move Notes Up Ignoring Key
