...
reaper.MB([[This script has been replaced by "js_Mouse editing - 2-sided Warp".

The new "Mouse editing" scripts require the js_ReaScriptAPI extension, and have several advantages, including:
