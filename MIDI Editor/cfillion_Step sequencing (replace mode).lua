...
-- @provides
--   [main=main] .
--   [effect] cfillion_Step sequencing (replace mode)/New file 1.lua > cfillion_Step sequencing (replace mode)/Step sequencing (replace mode).jsfx
...
local jsfx
local jsfxName = 'ReaTeam Scripts/MIDI Editor/cfillion_Step sequencing (replace mode)/Step sequencing (replace mode).jsfx'
