...
for i=0, numItems-1 do 
    ...
    if reaper.ValidatePtr2(0, curItem, "MediaItem*") then 
        ...
        for t=0, numTakes-1 do 
            ...
            if reaper.ValidatePtr2(0, curTake, "MediaItem_Take*") then
                ...
                if gotAllOK then
                    ...
                    -- Iterate through all MIDI events, looking for notation events and matching notes
                        ...
                        then
                            ...
                            if tableNoteOns[channel][pitch] then
                                ...
                                reaper.ShowMessageBox("There appears to be overlapping notes among the notes with notation. Such notes cannot be parsed by this script."
                                                      ...
                                                      , "ERROR", 0)
                                reaper.Undo_EndBlock("INCOMPLETE: Select all notes that have customized display lengths or positions", -1)
                                return false
