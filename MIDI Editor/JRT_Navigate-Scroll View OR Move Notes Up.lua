...
@version 1.0
@provides . > JRT_Navigate-Scroll View OR Move Notes Up
@about For streamlined MIDI Editor navigation – pairs well with JRT_Navigate-Scroll View OR Move Notes Down
