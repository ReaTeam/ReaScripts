...
@version 1.0
@provides . > JRT_Navigate-Scroll View OR Move Notes Down
@about For streamlined Midi Editor navigation – pairs well with JRT_Navigate-Scroll View OR Move Notes Up.lua
