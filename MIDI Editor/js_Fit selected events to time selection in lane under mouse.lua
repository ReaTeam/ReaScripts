--[[
ReaScript name:  js_Fit all selected events to time selection in lane under mouse.lua
Version: 2.00
Author: juliansader
...
About:
  ...
  Move and stretch selected events in the lane under the mouse (notes, sysex, pitchwheel, CCs etc) to fit precisely into time selection.
  
  # Instructions
  
  The script can be linked to a shortcut key, or it can be included in the CC lane context menu.
]]
...
-- Settings that the user can customize
    ...
    lane_to_use = "under mouse" -- "all", "last clicked" or "under mouse"
