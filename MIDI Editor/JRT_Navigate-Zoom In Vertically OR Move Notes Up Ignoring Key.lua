@description JRT_Navigate-Zoom In Vertically OR Move Notes Up Ignoring Key
@author JRTaylorMusic
@version 1.0
@provides . > JRT_Navigate-Zoom In Vertically OR Move Notes Up Ignoring Key
@about For streamlined MIDI Editor Navigation – Pairs well with JRT_Navigate-Zoom Out Vertically OR Move Notes Down Ignoring Key
