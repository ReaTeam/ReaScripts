-- @description Set time selection to razor edits' start and end (selected tracks only)
-- @author amagalma
-- @version 1.00
-- @about
--   Sets the time selection to begin at the earliest razor edit start and to end at the latest razor edit end.
--   Takes into account only the selected tracks
