-- @description Set first selected point to last selected point value in AI
-- @author Edgemeal
-- @version 1.0
...
if (a1 ~= -1) and (a2 ~= -1) then
  ...
  reaper.SetEnvelopePointEx(env, a1, p1, _, v2, _, _, true, false)
  reaper.UpdateArrange()
  reaper.Undo_EndBlock("Set first selected point to last selected point value in AI", -1)  
end
