...
-- @about
--   # Freeze Tracks to Mono/Stereo (Lua Script) — v1.0
--
--   **by Grave Sound Audio Store**
--
--   ---
--
--   ## Overview
--
--   A small Lua script for REAPER designed to fix a gap in the default workflow.
--
--   REAPER’s performance meter is great for identifying CPU-heavy tracks. Still, it doesn’t provide a fast way to act on that information—especially when it comes to freezing tracks to **mono or stereo**.
--
...
--   ## Features
--
--   - Freeze selected tracks to **mono**
--   - Freeze selected tracks to **stereo**
--   - Unfreeze selected tracks
--   - Detect and display already frozen tracks
...
--   Typical workflow:
--
--   - Check performance meter  
--   - Find problem track  
--   - Freeze track  
--   - Realise it’s still stereo / not optimal  
--   - Undo → redo manually  
--
--   This script removes that loop, speeding up the process.
--
--   ---
--
--   ## Usage
...
--   5. Select the script
--   6. (Optional) Assign a shortcut or toolbar button
--
--   ---
--
--   ### ReaPack (Coming Soon)
--
--   1. Add repository URL (to be provided)
--   2. Search for:  
--      `Freeze Tracks to Mono/Stereo`
--   3. Install via ReaPack
--
--   ---
--
--   ## Changelog
...
--
--   - Mono freeze support  
--   - Stereo freeze support  
--   - Unfreeze functionality  
--   - Multi-track support  
--   - Basic frozen state detection  
--
--   ---
--
--   ## Notes
--
--   - Designed for heavy sessions (FX-heavy / oversampling workloads)
--   - Uses REAPER’s native freeze system
--   - Built for speed and minimal workflow disruption
--
--   ---
--
--   ## Feedback / Issues
--
--   If you run into bugs or have feature requests, open an issue or reply in the REAPER forum thread.
--
--   ---
--
--   ## Author
--
--   **Grave Sound Audio Store**
