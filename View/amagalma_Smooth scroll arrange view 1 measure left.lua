-- @description Smooth scroll arrange view 1 measure left
-- @author amagalma
-- @version 1.00
-- @provides
--   .
--   [main] . > amagalma_Smooth scroll arrange view 2 measures left.lua
--   [main] . > amagalma_Smooth scroll arrange view 4 measures left.lua
--   [main] . > amagalma_Smooth scroll arrange view 8 measures left.lua
...
if wanted_time < 0 then wanted_time = 0 end
local total_shift = a0 - wanted_time
