--[[
Description: Duplicate selected notes (chromatic)...
Version: 1.0.1
Author: Lokasenna
Donation: https://paypal.me/Lokasenna
Changelog:
	Added Undo statements
	Revised to match the diatonic version of this script
Links:
...
local function dup_notes()
	...
	local interval = interval_arr[GUI.Val("mnu_intervals")][2] or nil
