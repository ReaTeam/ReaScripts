-- @description Moves items rigth, preserving crossfade lengths
-- @author Rodilab
-- @version 2.0
-- @about
--   Moves selected items rigth (1 pixel), preserving crossfade lengths.
...
if count > 0 then
  ...
  reaper.Undo_EndBlock("Move items right, preserving crossfade length",0)
end
