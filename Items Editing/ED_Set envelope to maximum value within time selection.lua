 ...
 * Description: This script will set all envelope points within time selection to maximum value, including edges of time selection. Works on both track and take envelopes.
 * Author: EvilDragon
 * Licence: GPL v3
 * REAPER: 5.0+
