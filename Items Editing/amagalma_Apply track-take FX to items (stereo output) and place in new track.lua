-- @description Apply track/take FX to items (stereo output) and place in new track
-- @author amagalma
-- @version 1.00
-- @about
--   # Applies the track/take FX to selected items (stereo output) and places them in a new track above or below
...
reaper.Undo_EndBlock( "Apply stereo FX to items, place in new track", 1 )
