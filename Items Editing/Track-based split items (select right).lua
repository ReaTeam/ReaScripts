...
--
--   This script is for item splitting (select right).  Download the other track based scripts to get item selection, range selection (shift-click), toggle selection, item split (select left) using the same modes.
--
