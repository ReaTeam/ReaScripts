-- @description Moves items left, preserving crossfade lengths
-- @author Rodilab
-- @version 2.0
-- @about
--   Moves selected items left (1 pixel), preserving crossfade lengths.
--   - In order to preserve the length of the fades, the edges of the next and previous items can be trimed.
...
if count > 0 then
  ...
  -- Move selected items and envelopes left
  ...
  reaper.Undo_EndBlock("Move items left, preserving crossfade lengths",0)
end
