...
Changelog:
	Added an option to restrict notes to the current time selection
Links:
...
GUI.x, GUI.y, GUI.w, GUI.h = 0, 0, 256, 176
...
GUI.elms = {
	...
	chk_time = GUI.Checklist:new(	1,	32, 96, "", "Only in time selection", "v", 4),
	btn_go = GUI.Button:new(		1,	96, 128, 64, 20, "Go!", fill_item),
