...
group_boundary = 0.6  -- time in seconds that item edges can exceed time selection before not being considered parallel in track group-based mode
...
---------------------Track group-based Item Selection  ----------------
