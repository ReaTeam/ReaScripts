...
-- @about
--   Map this to for example media item command-click in mouse modifiers to allow toggling selection of items based on the folder or track group they are contained in.  Also includes individual item toggle-selection and toggle-selection of items across all tracks.
--
...
--
--   This script is for toggling item selection.  Download the other track based scripts to get item selection, item range selection (shift-click) , item split (select right or left) using the same modes.
--
...
--@description Track-baseed non-contiguous Item Selection
--@author: triode
