--[[
  * ReaScript Name: Split all non-locked MIDI items at edit cursor
  * Description: - splits all non-locked MIDI items at edit cursor
...
function split(item_table, split_pos)
  ...
  r.UpdateArrange()
  r.Undo_EndBlock("Split all non-locked MIDI items at edit cursor", -1)
end
