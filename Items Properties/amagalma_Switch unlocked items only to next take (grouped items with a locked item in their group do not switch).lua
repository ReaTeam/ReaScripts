-- @description Switch unlocked items only to next take (grouped items with a locked item in their group do not switch)
-- @author amagalma
-- @version 1.00
-- @about Like native Take: Switch items to next take, but without switching takes for items that are locked or that they belong to a group with a locked item.
...
reaper.Undo_OnStateChange( "Switch unlocked items only to next take" )
