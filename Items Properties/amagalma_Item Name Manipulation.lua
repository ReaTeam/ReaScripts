...
local function Window_At_Center(w, h) -- Lokasenna function
  ...
  gfx.init("Item Names Manipulation", w, h, 0, x, y)
end
...
-- Check previous names of all items to their current names
...
local function main() -- MAIN FUNCTION
  ...
  -- Check every one second to see if the item selection has changed
