-- @description Calculate Peak to Loudness Ratio (PLR - new Crest Factor) of selected items source media
-- @author amagalma
-- @version 1.00
...
local ok3, info = reaper.GetSetProjectInfo_String( 0, "RENDER_STATS", "42468", false )
...
if plr_cnt ~= 0 then
  ...
  reaper.ShowConsoleMsg("--- Peak to Loudness Ratio of selected items source media ---\n")
