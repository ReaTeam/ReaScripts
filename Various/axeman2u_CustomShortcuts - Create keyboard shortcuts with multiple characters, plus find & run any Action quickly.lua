...
-- @provides
--   [nomain] .
--   axeman2u_CustomShortcuts - Create keyboard shortcuts with multiple characters, plus find & run any Action quickly/CustomShortcuts_capture.lua
--   axeman2u_CustomShortcuts - Create keyboard shortcuts with multiple characters, plus find & run any Action quickly/CustomShortcuts_core.lua
--   axeman2u_CustomShortcuts - Create keyboard shortcuts with multiple characters, plus find & run any Action quickly/CustomShortcuts_Create.lua
--   axeman2u_CustomShortcuts - Create keyboard shortcuts with multiple characters, plus find & run any Action quickly/MIT License.txt
--   axeman2u_CustomShortcuts - Create keyboard shortcuts with multiple characters, plus find & run any Action quickly/README.txt
--   axeman2u_CustomShortcuts - Create keyboard shortcuts with multiple characters, plus find & run any Action quickly/MIT License.txt > axeman2u_CustomShortcuts - Create keyboard shortcuts with multiple characters, plus find & run any Action quickly/New file 16.txt
-- @about Assign custom keyboard shortcuts of 18 characters max (not just single keys) to REAPER actions, then find and launch them through a fast, searchable window — quicker than REAPER's own Action List, even for actions with no shortcut at all. Only one REAPER shortcut needed to open it.
